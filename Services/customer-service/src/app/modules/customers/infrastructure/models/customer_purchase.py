...
class CustomerPurchaseModel(Base):
    ...
    # document_id references an external service (documents-service). Do not
    # enforce cross-service foreign keys in the local DB schema to allow
    # independent service bootstrap and local testing.
